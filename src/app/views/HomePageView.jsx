...
export default function HomePageView() {
    ...
    return (
        <div className="accueil bg-cover bg-[url('./imgs/bggradient.svg')]">
            <div className='recherche bg-rose bg-opacity-25 h-24 pt-7 '>

                <div className="flex flex-row items-center justify-around  ">

                    <div className=''>
                        {/* <label for="inputDeparture">Départ :</label> */}
                        <input  className='inputInscription 'type="text" name="departure" id="inputDeparture" placeholder="Point de départ"></input>
                    </div>

                    <div className=''>
                        {/* <label for="inputDestination">Destination :</label> */}
                        <input className='inputInscription' type="text" name="destination" id="inputDestination" placeholder="Point d'arrivée"></input>
                    </div>

                    <div className=''>
                        {/* <label for="inputDate">Date :</label> */}
                        <input className='inputInscription' type="date" name="date" id="inputDate"></input>
                    </div>

                    <div className=''>
                        {/* <label for="inputNumber">Nombre de personnes :</label> */}
                        <input className='inputInscription' type="number" min="0" name="number" id="inputNumber" placeholder="Nombre de personnes"></input>
                    </div>
            ...
            <div className=''>
                ...
                <div className='flex mx-auto w-1/2 h-auto '>
                    <img className='rounded-lg drop-shadow-lg' src="imgs/pexels-lisa-fotios-1392621.jpg" alt="voiture"></img>
                </div>
