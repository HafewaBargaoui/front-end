...
const AddVehiculeModal = ({setmodalOn, user, vehicule, pref, users, count, setCount}) => {
          ...
          <div className="w-full mt-24 max-w-lg lg:px-8 bg-black bg-opacity-30 rounded-lg shadow-lg shadow-gray-900/80">
            <div className="grid grid-cols-3 gap-4 pt-4 place-items-center ">
              <div className="h-20 w-36  grid grid-flow-row place-items-center ">
                <p className="text-xs text-white  uppercase font-semibold">marque</p>
                <select
              ...
              <div className="h-20 w-36   grid grid-flow-row place-items-center ">
                <p className="text-xs text-white uppercase font-semibold">modele</p>
                <select
              ...
              <div className="h-20 w-36   grid grid-flow-row place-items-center ">
                <p className="text-xs text-white  uppercase font-semibold">carburant</p>
                <select
            ...
            <div className="grid grid-cols-2 gap-4 p-4 place-items-center ">
              ...
              <div className="h-20 w-48  grid grid-flow-row place-items-center ">
                <p className="text-xs text-white  uppercase font-semibold">espace</p>
                <select
