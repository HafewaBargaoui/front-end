...
import { URL_BUYCOINS } from "../../../constants/urls/urlFrontEnd";



const GoBuyCoins = ({setmodalOn}) => {
  ...
  return (
    <div className="h-full w-full absolute top-0 left-0 flex justify-center items-center bg-black bg-opacity-50 backdrop-blur-sm z-50"
         onClick={clickOut}    
        >

        <div ref={modalRef}>
        <div className="relative w-full h-full max-w-md md:h-auto">
             <div className="relative h-52 grid place-items-center bg-black shadow rounded-lg">
               <button
                 type="button"
                 onClick={closeClick}
               ...
               <h3 className="mb-5 text-lg font-light text-white">
                   Votre solde de buddycoins est insuffisant pour ce trajet
                 </h3>                 
                 <h6 className="mb-5 text-md font-light text-white">
                   souhaitez vous crediter votre solde ?
                 </h6>
                 <button
